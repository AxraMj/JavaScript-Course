...
const calculateHighestAmong = () => {
    ...
    if (johnBMI > markBMI) {
        console.log(`${calJohnBMI.fullName}'s BMI (${johnBMI}) is higher than ${calMarkBMI.fullName}'s (${markBMI})!`);
    } else {
        console.log(`${calMarkBMI.fullName}'s BMI (${markBMI}) is higher than ${calJohnBMI.fullName}'s (${johnBMI})!`);
    }
};
